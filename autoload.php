...
include 'permission/models/Permission.php';
include 'permission/models/Role.php';
include 'permission/traits/HasRole.php';
include 'mail.php';
include 'notifications/traits/notifiable.php';
include 'notifications/class/notification.php';
include 'pdf.php';
include 'qr.php';
...
include 'validations/class/rule.php';
include 'validations/class/validation.php';
include 'validations/interfaces/rule.php';
include 'var.php';
include 'test.php';
