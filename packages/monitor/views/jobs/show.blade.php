...
<body class="bg-neutral-100">
	<h1 class="mx-6 py-4 text-4xl font-semibold">
		<div class="flex justify-between">
			<div>
				...
				Detalles del trabajo en segundo plano
			</div>

			<div>
				<a title="Ir a atrás" href="/monitor/jobs">
	...
	<div class="bg-white m-5 rounded pb-5">
		<div class="w-full m-5">
			...
			<div class="flex m-5">
				<div class="w-1/4">Trabajo</div>
				<div class="w-3/4">{{ $item->content->name }}</div>
			</div>

			<div class="flex m-5">
				<div class="w-1/4">Cola</div>
				<div class="w-3/4">{{ $item->content->queue }}</div>
			</div>
